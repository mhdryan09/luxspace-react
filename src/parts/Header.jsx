			...
			<div className="container py-5 mx-auto">
				<div className="flex items-center flex-stretch">
					...
					<div className="w-auto">
						<ul className="fixed inset-0 flex flex-col items-center justify-center invisible bg-white opacity-0 md:visible md:flex-row md:bg-transparent md:relative md:opacity-100 md:flex md:items-center" id="menu">
					...
					<div className="w-auto">
						<ul className="flex items-center">
							<li className="block ml-6 md:hidden">
								<button id="menu-toggler" className="relative z-50 flex items-center justify-center w-8 h-8 text-black md:text-white focus:outline-none">
							...
							<li className="ml-6">
								<Link to="/cart" className="flex items-center justify-center w-8 h-8 text-black md:text-white" href="cart.html">
